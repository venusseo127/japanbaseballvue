<template>
  <div class="playground">
    ...
    <div class="tblbox" id="bbground">
      ...
      <!-- <div class="currentPlayer p1" id="player1">
    ...
    <div class="row" style="width: 100%;background-color: #eaeaea;">
        ...
        <div class="col-4" color="primary" style="text-align: right;padding: 5px 10px;"><q-btn @click="ballFielded=true;fieldersBtn=false;" icon-right="redo" style="font-size:15px" :label="$t('redo')"/></div>
      </div>
    <q-dialog
          ...
          <div class="ballFieldpop">
            ...
            <div class="row center-justify" >
              <div class="col-12 text-center ballFieldpopBox">
                <q-img  name='CF' src="/img/catchermitt2.png" @click="ballFieledTo('centerField')" spinner-color="white" class="catchermitt" >
            ...
            <div class="row" style="margin:10px 0px;">
              <div class="col-6">
                <q-img src="/img/catchermitt2.png"  @click="ballFieledTo('leftField')" spinner-color="white" class="catchermitt" >
              ...
              <div class="col-6 text-right">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('rightField')" spinner-color="white" class="catchermitt" >
            ...
            <div class="row" style="margin: 10px 0px 50px;">
              <div class="col-6 text-right">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('shortStop')" spinner-color="white"  class="catchermitt" >
                  ...
                  <q-btn v-if="this.gameEventData===undefined" class="catcherBtn" style="margin-right: 24%;" label="SS" />
                </q-img>
              </div>
              <div class="col-6">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('secondBase')" spinner-color="white"  class="catchermitt" >
            ...
            <div class="row" style="margin-bottom:30px;">
              <div class="col-4">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('thirdBase')" spinner-color="white"  class="catchermitt" >
              ...
              <div class="col-4 text-center">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('pitcher')" spinner-color="white"  class="catchermitt" >
              ...
              <div class="col-4 text-right">
                <q-img src="/img/catchermitt2.png" @click="ballFieledTo('firstBase')" spinner-color="white"  class="catchermitt" >
    ...
    >
      <div class='row'>
        <div class="col-12" style="background-color:gray;text-align:center;padding:10px;">
            ...
            <div ><q-btn flat dense :label="$t('cancel')" @click="this.runnerScore=true;fieldersBtn=true" style="font-size: 20px;" color="primary"  /></div>
        </div>
        <div class="col-12 ">
          <div class="runnerScorePop">
            <div class="fixed-bottom" style="text-align: center;margin-bottom: 32%;">
